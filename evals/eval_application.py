...
def run(rag):
    ...
    result = evaluate(test_cases=test_cases, metrics=[correctness, completeness, style], async_config=AsyncConfig(run_async=False))
    return summarize_by_metric(result)


def run_local():
    """Standalone convenience: build the RAG pipeline, then run."""
